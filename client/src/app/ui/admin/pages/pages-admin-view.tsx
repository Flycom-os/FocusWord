...
const PagesPage = () => {
  ...
  const tableSelection = useTableSelection({
    ...
    onSelectionChange: (selectedIds) => {
      console.log("Selected pagesd:", selectedIds);
    },
  });
            ...
            pages.map((page, index) => (
              ...
              >
                ...
                <TableCell className={styles.actions}>
                  <UiButton theme="secondary" onClick={() => handleEditPage(page)}> Edit </UiButton>
                  <PermissionGate resource="pages" level={2}>
                    <UiButton theme="warning" onClick={() => handleDelete(page.id)}> Delete </UiButton>
                  </PermissionGate>
                </TableCell>
              </SelectableTableRow>
            ))
