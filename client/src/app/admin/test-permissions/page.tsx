  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-gray-100 p-4 rounded-lg mb-4">
        ...
        <p>
          <strong>Пользователь:</strong> {user?.email || "Не авторизован"}
        </p>
        <p>
          <strong>Токен в localStorage:</strong>{" "}
          {accessToken ? `${accessToken.substring(0, 20)}...` : "Нет"}
        </p>
        <p>
          <strong>Токен в cookie:</strong>{" "}
          {cookieValue ? `${cookieValue.substring(0, 20)}...` : "Нет"}
        </p>
      </div>
      ...
      <div className="bg-gray-100 p-4 rounded-lg mb-4">
        ...
        <p>
          ...
          {hasPermission("media-files", 0) ? "✅ Есть" : "❌ Нет"}
        </p>
        <p>
          <strong>Media files (level 1):</strong>{" "}
          {hasPermission("media-files", 1) ? "✅ Есть" : "❌ Нет"}
        </p>
        <p>
          <strong>Media files (level 2):</strong>{" "}
          {hasPermission("media-files", 2) ? "✅ Есть" : "❌ Нет"}
        </p>
        <p>
          <strong>Users (level 0):</strong> {hasPermission("users", 0) ? "✅ Есть" : "❌ Нет"}
        </p>
        <p>
          <strong>Users (level 2):</strong> {hasPermission("users", 2) ? "✅ Есть" : "❌ Нет"}
        </p>
      </div>
