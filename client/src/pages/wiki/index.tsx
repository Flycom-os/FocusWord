                  ...
                  <ul className={styles.tocList}>
                    ...
                    <li className={styles.tocItem}>
                      ...
                      <ul className={styles.tocSublist}>
                        ...
                        <li>
                          <a href="#users-endpoints">Users</a>
                        </li>
                        <li>
                          <a href="#media-files">Media Files</a>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li className={styles.tocItem}>
                      ...
                      <ul className={styles.tocSublist}>
                        ...
                        <li>
                          <a href="#roles-table">Roles</a>
                        </li>
                        <li>
                          <a href="#media-files-table">Media Files</a>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li className={styles.tocItem}>
                      ...
                      <ul className={styles.tocSublist}>
                        ...
                        <li>
                          <a href="#permissions">Permission System</a>
                        </li>
                        <li>
                          <a href="#auth-system">Authentication</a>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li className={styles.tocItem}>
                      ...
                      <ul className={styles.tocSublist}>
                        <li>
                          <a href="#auth-security">Authentication Security</a>
                        </li>
                        <li>
                ...
                <section id="getting-started" className={styles.contentSection}>
                  ...
                  <div className={styles.sectionContent}>
                    <div id="installation" className={styles.subsection}>
                      <h2>Installation</h2>
                      <p>
                        Get FocusWord up and running on your local machine with these simple steps:
                      </p>
...
cd backend && npm run start:dev`}</code>
                    ...
                    <div id="configuration" className={styles.subsection}>
                      <h2>Configuration</h2>
                      <p>
                        FocusWord uses environment variables for configuration. Copy the example
                        files:
                      </p>
                      <div className={styles.codeBlock}>
                        <pre>
...
cp backend/.env.example backend/.env`}</code>
                        </pre>
                      </div>
                    </div>
                    ...
                    <div id="first-steps" className={styles.subsection}>
                      ...
                      <ol className={styles.stepList}>
                        ...
                        <li>
                          Check out the API documentation at <code>/api</code>
                        </li>
                      </ol>
                    </div>
                  </div>
...
?page=1&limit=10&search=admin`}</code>
                        </pre>
                      </div>
                    </div>
                  ...
                  <div className={styles.sectionContent}>
                    <div id="users-table" className={styles.subsection}>
                      ...
                      <ul className={styles.fieldList}>
                        ...
                        <li>
                          <strong>avatarUrl</strong> - Profile image URL
                        </li>
                        <li>
                          <strong>roleId</strong> - Foreign key to Roles
                        </li>
                      </ul>
                    </div>
                    ...
                    <div id="roles-table" className={styles.subsection}>
                      ...
                      <ul className={styles.fieldList}>
                        ...
                        <li>
                          <strong>permissions</strong> - JSON array of permissions
                        </li>
                        <li>
                    ...
                    <div id="media-files-table" className={styles.subsection}>
                      ...
                      <ul className={styles.fieldList}>
                        ...
                        <li>
                          <strong>filename</strong> - Original filename
                        </li>
                        <li>
                          <strong>filepath</strong> - File path/URL
                        </li>
                        <li>
                          <strong>mimetype</strong> - File MIME type
                        </li>
                        <li>
                          <strong>uploadedById</strong> - User who uploaded
                        </li>
                      </ul>
                    </div>
                  </div>
...
docker-compose -f docker-compose.ssl.yml up -d`}</code>
                        </pre>
                      </div>
                    </div>
