...
export class CreateArticleDto {
  ...
  @ApiProperty({
    description: 'Article template name',
    required: false,
    default: 'default',
  })
  @IsString()
  ...
  @ApiProperty({
    description: 'Category IDs to bind to the article',
    required: false,
    type: [Number],
  })
  @IsArray()
  ...
  @ApiProperty({
    description: 'Enable feedback framework on the article',
    required: false,
    default: true,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: 'The ID of the payment method to bind to the article',
    required: false,
  })
  @IsInt()
  @IsOptional()
