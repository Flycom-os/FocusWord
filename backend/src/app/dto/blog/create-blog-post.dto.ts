...
export class CreateBlogPostDto {
  ...
  @ApiProperty({
    description: 'The unique slug for the blog post',
    minLength: 3,
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'Blog post template name',
    required: false,
    default: 'default',
  })
  @IsString()
  ...
  @ApiProperty({
    description: 'Category IDs to bind to the blog post',
    required: false,
    type: [Number],
  })
  @IsArray()
  ...
  @ApiProperty({
    description: 'Enable feedback framework on the blog post',
    required: false,
    default: true,
  })
  @IsBoolean()
  ...
  @ApiProperty({
    description: 'The ID of the payment method to bind to the blog post',
    required: false,
  })
  @IsInt()
  @IsOptional()
